...
namespace DevOps.Util.DotNet.Triage.Migrations
{
    ...
    [Migration("20210922225854_AddHelixWorkItemName")]
    partial class AddHelixWorkItemName
    {
            ...
            modelBuilder.Entity("DevOps.Util.DotNet.Triage.ModelBuild", b =>
                {
                    ...
                    b.HasIndex("GitHubOrganization", "GitHubRepository", "PullRequestNumber");
            ...
            modelBuilder.Entity("DevOps.Util.DotNet.Triage.ModelTestResult", b =>
                {
                    ...
                    b.Property<string>("HelixWorkItemName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("StartTime")
                        .HasAnnotation("SqlServer:Include", new[] { "BuildResult", "BuildKind", "GitHubTargetBranch", "TestFullName", "TestRunName", "IsHelixTestResult", "HelixWorkItemName" });
