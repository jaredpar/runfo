...
namespace DevOps.Util.Triage.Migrations
{
    ...
    [Migration("20200911154230_TrackingCollections")]
    partial class TrackingCollections
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelBuildAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelTrackingIssue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelTrackingIssueMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelTrackingIssueResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelTimelineIssue", b =>
                {
                    b.HasOne("DevOps.Util.Triage.ModelBuildAttempt", "ModelBuildAttempt")
                        .WithMany()
            ...
            modelBuilder.Entity("DevOps.Util.Triage.ModelTrackingIssueMatch", b =>
                {
                    ...
                    b.HasOne("DevOps.Util.Triage.ModelTestResult", "ModelTestResult")
                        .WithMany()
                        .HasForeignKey("ModelTestResultId");

                    b.HasOne("DevOps.Util.Triage.ModelTimelineIssue", "ModelTimelineIssue")
                        .WithMany()
                        .HasForeignKey("ModelTimelineIssueId");

                    b.HasOne("DevOps.Util.Triage.ModelTrackingIssue", "ModelTrackingIssue")
